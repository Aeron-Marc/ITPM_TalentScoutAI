    ...
    if (!$stmt) {
      ...
      if (!$employee) {
        ...
        if (!$isValidPassword) {
          ...
          <body>
            <script>
              try { localStorage.setItem('employee_auth_state', <?php echo $loginDataJson; ?>); } catch (e) {}
            </script>
          </body>
          </html>
          <?php
    ...
    <main class="auth-wrap">
      <section class="auth-grid">
        <aside class="auth-info">
          ...
          <p>
            Access your personalized matches, monitor your applications, and keep building your profile with TalentScout AI.
          </p>
          <ul class="auth-points">
            <li>
              <span class="check-icon">✓</span>
              <span>Track applications in one dashboard</span>
            </li>
            <li>
              <span class="check-icon">✓</span>
              <span>Get fresh AI job recommendations weekly</span>
            </li>
            <li>
              <span class="check-icon">✓</span>
              <span>Receive alerts from local employers</span>
            </li>
          </ul>
        </aside>
