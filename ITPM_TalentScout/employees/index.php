  ...
  <body>
      ...
      <div class="hero-inner">
        <div>
          ...
          <p class="hero-desc">
            ...
            experience. Get AI-powered recommendations, build your resume, and
            track your applications in one place.
          </p>
          <div class="hero-actions">
            <a href="./modules/job-postings/" class="btn-hero-primary"
              >Browse Jobs</a
            >
            <a href="./modules/applicant-tracking/" class="btn-hero-outline"
              >Track Applications</a
            >
          </div>
        </div>
        ...
        <div class="hero-visual">
          <div class="mock-card">
            ...
            <div
              style="font-weight: 700; font-size: 1rem; margin-bottom: 0.25rem"
            >
              Senior React Developer
            </div>
            <div
              style="font-size: 0.82rem; opacity: 0.72; margin-bottom: 0.8rem"
            >
              Tech Solutions PH - Barangay Kaylaway
            </div>
            <div>
              <span class="mock-chip">React</span>
              <span class="mock-chip">TypeScript</span>
              <span class="mock-chip">Node.js</span>
            </div>
          </div>

          <div class="mock-card">
            <div
              style="font-size: 0.82rem; opacity: 0.7; margin-bottom: 0.6rem"
            >
            ...
            >
              ...
              ><span style="color: #98fbcb; font-weight: 700">100%</span>
            </div>
            ...
            >
              ...
              ><span style="color: #98fbcb; font-weight: 700">8 / 10</span>
            </div>
            <div class="mock-bar-bg">
              <div class="mock-bar-fill" style="width: 80%"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="features-bg">
      <div class="features-header">
        ...
        <p class="section-subtitle">
          Smart tools designed to help you find the right job, build your
      ...
      <div class="features-grid">
        <a href="./modules/job-postings/index.php" class="feature-card">
          ...
          <p class="feature-desc">
            ...
            Nasugbu. Filter by skills, location, salary, and job type.
          </p>
        ...
        <a href="./modules/ai-matching/index.php" class="feature-card">
          ...
          <p class="feature-desc">
            ...
            your skills and matches you with the best opportunities.
          </p>
        ...
        <a href="./modules/resume-builder/index.php" class="feature-card">
          ...
          <p class="feature-desc">
            ...
            skills and experience to stand out to employers.
          </p>
        ...
        <a href="./modules/skill-gap-analysis/index.php" class="feature-card">
          ...
          <p class="feature-desc">
            ...
            training you need to unlock more job opportunities.
          </p>
        ...
        <a href="#" class="feature-card">
          ...
          <p class="feature-desc">
            ...
            and level up your career prospects.
          </p>
        ...
        <a href="./modules/applicant-tracking/index.php" class="feature-card">
          ...
          <p class="feature-desc">
            ...
            through Interview to Successfully Hired.
          </p>
          <span class="feature-link">Track Applications -></span>
        </a>
      </div>
    </div>
    ...
    <div class="benefits-section">
      <div class="benefits-inner">
        <div class="benefits-header">
          <div class="section-label">Why Choose TalentScout</div>
        ...
        <div class="benefits-grid">
          <div class="benefit-item">
            ...
            <div class="benefit-desc">
              ...
              Get matched to roles that truly fit your skills.
            </div>
          </div>
          <div class="benefit-item">
            <div class="benefit-icon">🤝</div>
            ...
            <div class="benefit-desc">
              ...
              discrimination, no bias - pure talent recognition.
            </div>
          </div>
          <div class="benefit-item">
            <div class="benefit-icon">📈</div>
            ...
            <div class="benefit-desc">
              ...
              Nasugbu are actually looking for.
            </div>
          </div>
          <div class="benefit-item">
            ...
            <div class="benefit-desc">
              ...
              remotely for Nasugbu-based companies.
            </div>
          </div>
          <div class="benefit-item">
            <div class="benefit-icon">🔗</div>
            ...
            <div class="benefit-desc">
              ...
              communicate with employers instantly.
            </div>
          </div>
          <div class="benefit-item">
            <div class="benefit-icon">[ALL-IN-ONE]</div>
            <div class="benefit-title">One Dashboard</div>
            <div class="benefit-desc">
              Manage your profile, resume, job applications, and skill
    ...
    <section class="cta-section">
      <div class="cta-inner">
        ...
        <h2 class="cta-title">Start Your Job Search Today</h2>
        <p class="cta-desc">
          Join hundreds of job seekers who have found their dream jobs through
          TalentScout AI. Create your profile and get matched to opportunities
          in minutes.
        </p>
