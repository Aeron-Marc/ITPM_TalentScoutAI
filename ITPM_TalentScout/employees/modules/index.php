    ...
    <div class="modules-section">
      <div class="modules-inner">
        <div class="modules-header">
          ...
          <h2 class="section-title">Job Seeker Modules</h2>
          <p class="section-subtitle">
            Access all the tools you need to find opportunities, build your
        ...
        <div class="modules-grid">
          ...
          <a href="./job-postings/index.php" class="module-card">
            ...
            <div class="module-desc">
              Browse hundreds of job opportunities across all barangays in
              Nasugbu. Filter by skills, location, and salary.
            </div>
            <span class="module-link">View Jobs →</span>
          </a>
          ...
          <a href="./ai-matching/index.php" class="module-card">
            ...
            <div class="module-desc">
              ...
              AI-powered matching finds your perfect fit.
            </div>
            <span class="module-link">See Matches →</span>
          </a>
          ...
          <a href="./skill-gap-analysis/index.php" class="module-card">
            ...
            <div class="module-desc">
              Discover what skills you need to unlock more opportunities. Get
              personalized course recommendations.
            </div>
            <span class="module-link">Analyze Skills →</span>
          </a>
          ...
          <a href="./applicant-tracking/index.php" class="module-card">
            ...
            <div class="module-desc">
              Monitor your applications in real-time. Track progress from
              pending applications through job offers.
            </div>
            <span class="module-link">Track Applications →</span>
          </a>
          ...
          <a href="./resume-builder/index.php" class="module-card">
            ...
            <div class="module-desc">
              Create a professional resume in minutes. Simple step-by-step process
