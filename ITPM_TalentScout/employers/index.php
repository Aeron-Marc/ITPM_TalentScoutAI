...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-muted {
      background: linear-gradient(135deg, #9ca89f 0%, #8a9a8a 100%) !important;
      cursor: not-allowed !important;
      opacity: 0.7;
...
<div class="verification-banner">
  ...
  <span class="verification-banner-link" onclick="showUploadDocsModal()">Submit Documents</span>
...
<div class="mobile-nav" id="mobileNav">
  ...
  <?php else: ?>
    <a href="#" onclick="showVerificationModal(); return false;">📋 Post Jobs</a>
  <?php endif; ?>
  ...
  <?php else: ?>
    <a href="#" onclick="showVerificationModal(); return false;">📊 Hiring Pipeline</a>
    <a href="#" onclick="showVerificationModal(); return false;">💬 Messages</a>
  <?php endif; ?>
  ...
  <div class="hero-inner">
    <div class="hero-content">
      ...
      <div class="hero-actions">
        ...
        <?php else: ?>
          <button type="button" class="btn-hero-primary btn-muted" onclick="showVerificationModal()">
            📋 Post a Job
          </button>
        <?php endif; ?>
...
<div id="verificationModal" class="verification-modal-overlay" role="dialog" aria-modal="true" aria-labelledby="verificationModalTitle">
  <div class="verification-modal">
    ...
    <div class="verification-modal-actions">
      <button class="verification-modal-btn verification-modal-btn-secondary" onclick="closeVerificationModal()">Close</button>
    </div>
  </div>
</div>
...
.upload-docs-message.success {
  display: block;
  background: var(--mint);
  color: var(--sage-dark);
  border: 1px solid var(--mint-mid);
}
.upload-docs-message.error {
  display: block;
  background: #fef2f2;
  color: #b91c1c;
