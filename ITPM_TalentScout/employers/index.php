...
<head>
  ...
  <link rel="stylesheet" href="../styles/page-layout.css"></head>
<body>
  ...
  <div class="hero-inner">
    <div>
      ...
      <div class="hero-actions">
        <a href="./modules/post-jobs/" class="btn-hero-primary">Post a Job</a>
        <a href="./modules/blind-hiring/" class="btn-hero-outline">Learn About Blind Hiring</a>
      </div>
    </div>
    ...
    <div class="hero-visual">
      <div class="mock-card">
        ...
        <div style="font-size:0.82rem; opacity:0.72; margin-bottom:0.8rem;">3 Applications • 5+ Matches</div>
        <div>
          <span class="mock-chip">Python</span>
          <span class="mock-chip">Django</span>
          <span class="mock-chip">PostgreSQL</span>
        </div>
      </div>

      <div class="mock-2col">
        <div class="mock-card">
          <div style="font-size:0.75rem;opacity:0.65;margin-bottom:0.25rem;">Active Postings</div>
          <div style="font-size:1.6rem;font-weight:800;color:#98FBCB;">12</div>
          <div style="font-size:0.72rem;opacity:0.60;margin-top:0.15rem;">→ Reach 300+ candidates</div>
        </div>
        <div class="mock-card">
          <div style="font-size:0.75rem;opacity:0.65;margin-bottom:0.25rem;">This Month Hired</div>
          <div style="font-size:1.6rem;font-weight:800;color:#98FBCB;">7</div>
          <div style="font-size:0.72rem;opacity:0.60;margin-top:0.15rem;">→ Avg 8 days to hire</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="features-bg">
  <div class="features-header">
    <div class="section-label">Employer Solutions</div>
    <h2 class="section-title">Recruitment Made Simple</h2>
    <p class="section-subtitle">Complete hiring tools to find, screen, and hire the right talent. All in one platform.</p>
    <div style="margin-top:1.5rem;"><a href="./modules/" class="btn btn-primary">View All Tools</a></div>
  </div>
...
<div class="benefits-section">
  <div class="benefits-inner">
    <div class="benefits-header">
      <div class="section-label">Why TalentScout For Employers</div>
      <h2>Hire Better, Faster, Smarter</h2>
    </div>
...
<section class="cta-section">
  <div class="cta-inner">
    <div class="section-label">Ready to Find Top Talent?</div>
...
<script>
  ...
  document.querySelectorAll('.feature-card, .benefit-item, .module-card').forEach(card => {
