...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'create_job') {
  ...
  if ($title && $category && $description && $salary && $location && $work_type && $skills) {
    ...
    $stmt->bind_param("isssssss", $employer_id, $title, $description, $salary, $location, $work_type, $deadline, $skills, $category);
  ...
  <div class="main-layout">
    ...
    <div class="content-col">
      ...
      <?php if (!empty($success_message)): ?>
        <div style="background: #d4edda; color: #155724; padding: 1rem; border-radius: var(--radius-sm); margin-bottom: 1.5rem; border-left: 4px solid #155724;">
      ...
      <div class="modal-body">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <input type="text" name="location" class="input" placeholder="Barangay or area" required>
          </div>
        </div>
